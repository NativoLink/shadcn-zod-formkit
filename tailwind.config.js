...
module.exports = {
  ...
  safelist: [
    ...
    'border-blue-400', 'border-green-400', 'border-red-400', 'border-purple-400', 

    // soft bg
    "bg-blue-500/10", "bg-yellow-500/10", "bg-red-500/10", "bg-green-500/10", "bg-purple-500/10",
    "bg-amber-50", "bg-red-600",'bg-amber-400/10',
    'bg-blue-400/10', 'bg-green-400/10', 'bg-red-400/10', 'bg-purple-400/10',
